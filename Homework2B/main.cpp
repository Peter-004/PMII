...
int main(int argc, char* argv[]) {
    if (argc != 3) {
        std::cerr << "Usage: " << argv[0] << " num_locations num_events" << argv << std::endl;
        return 1;
    }
    ...
    //int num_locations = 1; // Number of locations to consider
    //int num_events = 5; // Number of events to include in the "timeline"
...
/* Manual Debugging
int main() {
    std::vector array1 = {1,2,6,8,4,3,15,55,40};
    MinHeap mH = MinHeap(array1);
    mH.insert(3);
    std::cout << mH.heap << std::endl;
    return 0;
}
*/
// Example tests
